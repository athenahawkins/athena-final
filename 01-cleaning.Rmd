...
First, I spoke with an expert on USDA reports about one row with an N/A price from 2018 - he said this row is a repeat leftover from combining reports.
...
clean_adj_cheese #check to make sure there is only one fewer row in the data
```
