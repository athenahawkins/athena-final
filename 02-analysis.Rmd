...
- Which month out of the year the highest average cheese prices in 2021 dollars? I'll group by year and month, then month again to get this answer.
- What were the monthly average prices for each type of cheese in 2021?
...
ggplot(thisyear_price, aes(x = date, y = avg_price)) +
  geom_line() +
  labs(title = "2022 Cheese Prices", color = "Price",
...
### Storage over time plot

```{r yearly_storage}
ggplot(storage_yrly, aes(x=yr)) + 
  geom_line(aes(y=avg_yrly_holding, color="avg_yrly_holding")) + 
  labs(title = "National Cheese Storage Holdings Over Time", 
